...
context('Sign up functionality', () => {
    ...
    beforeEach(() => {
        cy.visit('https://payments-dev.1tech.net/city-of-decatur');

    })


    it('Sign up end-to-end', () => {
        ...
        cy.request({
            ...
            const matchingEmail = response.body.find(email => email.to_email === randomEmail);
        ...
        cy.sqlServer("SELECT TOP 1 AI.AccountNumber, AICP.[Value] AS CID FROM AccountInformation AI JOIN AccountInformationCustomProperties AICP ON AI.Id = AICP.AccountInformationId AND AICP.PropertyKey = 'CID' WHERE AI.ClientId = 5 AND AI.Active = 1 AND AI.UserId IS NULL ORDER BY NEWID()")
